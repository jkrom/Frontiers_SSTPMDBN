...
# sys.argv[3] ... synaptic length scale d in mm 
# sys.argv[4] ... initial mean synaptic weight
# Note that the default systems length scale L=5 mm, this is specified in functions_pars.gen_Parameter_set_Sequence_Paper( ) 
# with the arguments 'x_STN_min' and 'x_STN_max'.
#############################################
# load shell input
...
TBackupSteps = np.arange(0,25000,1000) # sec
...
## set simulation time
system_parameters['Tend'] = 10020.0 # sec
system_parameters['d_mm'] = d_synaptic_length_scale # mm
...
synConnections , cMatrix , neuronLoc , sim_objects = functions_genNetwork.sequence_paper_generate_connectivity_and_weight_matrix_1D( system_parameters , rnd_state_for_network_generation, d_synaptic_length_scale )
